 ...
 *
 */
public class ModifiedEditGraphModalMousePlugin<V,E> extends AbstractGraphMousePlugin implements MouseListener, MouseMotionListener {
	...
	public CubicCurve2D getRawEdge() {
		return rawEdge;
	}
	public void setRawEdge(CubicCurve2D rawEdge) {
	...
	public Shape getRawArrowShape() {
		return rawArrowShape;
	}
	public void setRawArrowShape(Shape rawArrowShape) {
		this.rawArrowShape = rawArrowShape;
	}
	...
	public VisualizationServer.Paintable getEdgePaintable() {
		return edgePaintable;
	}
	public void setEdgePaintable(VisualizationServer.Paintable edgePaintable) {
		this.edgePaintable = edgePaintable;
	}
	public VisualizationServer.Paintable getArrowPaintable() {
		return arrowPaintable;
	}
	public void setArrowPaintable(VisualizationServer.Paintable arrowPaintable) {
	...
	public EdgeType getEdgeIsDirected() {
		return edgeIsDirected;
	}
	public void setEdgeIsDirected(EdgeType edgeIsDirected) {
